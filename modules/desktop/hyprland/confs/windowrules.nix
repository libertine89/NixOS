...

{
  windowrule = [
    ...
    # Terminals
    # =========================
    "opacity 0.80 0.70, match:class ^(kitty|alacritty|wezterm)$"

    # =========================
    # File managers / system tools
    # =========================
    "opacity 0.80 0.70, match:class ^(org.gnome.Nautilus|Thunar|pcmanfm|org.kde.dolphin|org.kde.ark|gnome-disks|org.gnome.FileRoller)$"

    # =========================
    # GTK / Qt tools
    # =========================
    "opacity 0.80 0.70, match:class ^(qt5ct|qt6ct|nwg-look|yad|gjs)$"

    # =========================
    # Comms / utilities
    # =========================
    "opacity 0.80 0.70, match:class ^(discord|com.github.rafostar.Clapper|com.github.tchx84.Flatseal|hu.kramo.Cartridges|app.drey.Warp|net.davidotek.pupgui2|io.gitlab.theevilskeleton.Upscaler)$"

    # =========================
    # System utilities
    # =========================
    "opacity 0.80 0.70, match:class ^(pavucontrol|blueman-manager|nm-applet|nm-connection-editor|org.kde.polkit-kde-authentication-agent-1|xdg-desktop-portal-gtk|xdg-desktop-portal-kde)$"
    ...
    "tag +games, match:class ^(steam_app.*|steam_app_[0-9]+)$"
    "tag +games, match:class ^(gamescope|Waydroid|osu!)$"
